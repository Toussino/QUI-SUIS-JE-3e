...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_circulatoire;

import java.util.Random;

public class Activiter_circulatoire extends AppCompatActivity implements View.OnClickListener {


    Button button1,button2,button3,button4;
    private Model_circulatoire question = new Model_circulatoire();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_circulatoire);
