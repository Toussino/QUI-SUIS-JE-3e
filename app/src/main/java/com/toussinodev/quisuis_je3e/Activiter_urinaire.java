...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_urinaire;

import java.util.Random;

public class Activiter_urinaire extends AppCompatActivity implements View.OnClickListener {




    Button button1,button2,button3,button4;
    private Model_urinaire question = new Model_urinaire();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_urinaire);
