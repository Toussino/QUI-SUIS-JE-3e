...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_maladie;

import java.util.Random;

public class Activiter_maladie extends AppCompatActivity implements View.OnClickListener {



    Button button1,button2,button3,button4;
    private Model_maladie question = new Model_maladie();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_maladie);
