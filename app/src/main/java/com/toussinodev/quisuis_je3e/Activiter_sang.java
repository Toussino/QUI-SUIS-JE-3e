...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_sang;

import java.util.Random;

public class Activiter_sang extends AppCompatActivity implements View.OnClickListener {



    Button button1,button2,button3,button4;
    private Model_sang question = new Model_sang();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_sang);
