...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_caracteristique;

import java.util.Random;

public class Activiter_caracteristique extends AppCompatActivity implements View.OnClickListener {




    Button button1,button2,button3,button4;
    private Model_caracteristique question = new Model_caracteristique();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_caracteristique);
