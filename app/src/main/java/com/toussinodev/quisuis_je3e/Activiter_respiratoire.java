...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_respiratoire;

import java.util.Random;

public class Activiter_respiratoire extends AppCompatActivity implements View.OnClickListener {



    Button button1,button2,button3,button4;
    private Model_respiratoire question = new Model_respiratoire();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_respiratoire);
