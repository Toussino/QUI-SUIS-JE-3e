...
import com.toussinodev.quisuis_je3e.model_questionnaire_niveau.Model_niveau2;

import java.util.Random;

public class Niveau2_activiter extends AppCompatActivity implements View.OnClickListener{




    Button button1,button2,button3,button4;
    private Model_niveau2 question = new Model_niveau2();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveau2_activiter);
