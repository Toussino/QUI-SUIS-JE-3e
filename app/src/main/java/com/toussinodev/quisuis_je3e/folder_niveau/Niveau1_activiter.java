...
import com.toussinodev.quisuis_je3e.model_questionnaire_niveau.Model_niveau1;

import java.util.Random;

public class Niveau1_activiter extends AppCompatActivity implements View.OnClickListener{




    Button button1,button2,button3,button4;
    private Model_niveau1 question = new Model_niveau1();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveau1_activiter);
