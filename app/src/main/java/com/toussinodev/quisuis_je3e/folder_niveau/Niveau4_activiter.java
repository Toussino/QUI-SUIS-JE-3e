package com.toussinodev.quisuis_je3e.folder_niveau;
...
import com.toussinodev.quisuis_je3e.R;
import com.toussinodev.quisuis_je3e.model_questionnaire_niveau.Model_niveau4;

import java.util.Random;

public class Niveau4_activiter extends AppCompatActivity implements View.OnClickListener {
    ...
    private Model_niveau4 question = new Model_niveau4();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveau4_activiter);
