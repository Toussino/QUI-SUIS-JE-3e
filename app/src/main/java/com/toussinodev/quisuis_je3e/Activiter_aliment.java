...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_aliment;

import java.util.Random;

public class Activiter_aliment extends AppCompatActivity implements View.OnClickListener {


    Button button1,button2,button3,button4;
    private Model_aliment question = new Model_aliment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_aliment);
