...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_muscle;

import java.util.Random;

public class Activiter_muscle extends AppCompatActivity implements View.OnClickListener{


    Button button1,button2,button3,button4;
    private Model_muscle question = new Model_muscle();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_muscle);
