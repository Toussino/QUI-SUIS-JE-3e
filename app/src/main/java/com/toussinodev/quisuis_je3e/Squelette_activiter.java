...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_Squelette;

import java.util.Random;

public class Squelette_activiter extends AppCompatActivity implements View.OnClickListener{

    Button button1,button2,button3,button4;
    private Model_Squelette question = new Model_Squelette();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squelette_activiter);
