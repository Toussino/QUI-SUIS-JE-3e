...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_maternite;

import java.util.Random;

public class Activiter_maternite extends AppCompatActivity implements View.OnClickListener {



    Button button1,button2,button3,button4;
    private Model_maternite question = new Model_maternite();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_maternite);
