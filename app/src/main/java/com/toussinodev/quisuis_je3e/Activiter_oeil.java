...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_oeil;

import java.util.Random;

public class Activiter_oeil extends AppCompatActivity implements View.OnClickListener {


    Button button1,button2,button3,button4;
    private Model_oeil question = new Model_oeil();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_oeil);
