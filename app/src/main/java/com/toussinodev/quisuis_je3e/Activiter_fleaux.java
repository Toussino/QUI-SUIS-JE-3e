...
import com.toussinodev.quisuis_je3e.model_questionnaire.Model_fleaux;

import java.util.Random;

public class Activiter_fleaux extends AppCompatActivity implements View.OnClickListener{



    Button button1,button2,button3,button4;
    private Model_fleaux question = new Model_fleaux();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiter_fleaux);
